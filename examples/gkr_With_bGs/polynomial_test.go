...
type PolynomialCircuit struct {
	Poly     Polynomial
	ZnO      frontend.Variable // for testing purposes only
	Expected frontend.Variable // for testing purposes only
}

func (pc *PolynomialCircuit) Define(curveID gurvy.ID, cs *frontend.ConstraintSystem) error {
...
func TestPolynomial(t *testing.T) {
	...
	var pc PolynomialCircuit

	pc.Poly.Coefficients = make([]frontend.Variable, 4)
